class SqliteViewerTable {
    ...
    addColumn(args){
        ...
        this.cols[u_id].tr = $(`<tr title='row: ${name}' class='table_columns' style='font-size:${this.fon_size};'></tr>`);
        this.cols[u_id].name_td = $(`<td style='font-size:inherit;background-color:inherit; color:inherit;'></td>`);
        this.cols[u_id].name_td_input =$(`<input type="text"  name="name" value='${name}' style='color:inherit;border:none;border-bottom:none;background-color:inherit;outline:none;' readonly></input>`);
        ...
        this.cols[u_id].type_td_options = $(`<select title='row: ${name}' style='font-size:inherit;border:none; background-color:inherit;color:inherit;'><option value="TEXT">TEXT</option> <option value="integer">INT</option></select>`);
        ...
        this.cols[u_id].pk_td_check = $(`<input type="checkbox" id="pk" name="pk" ${info && info.pk?'checked':''} disabled>`);
        ...
        this.cols[u_id].no_null_check = $(`<input type="checkbox" id="nnull" name="nnull" ${info && info.notnull?'checked':''} disabled>`);
        ...
        this.cols[u_id].fk_td_check = $(`<input type="checkbox" id="fk" name="fk" disabled>`);
    ...
    init(callBack){
        this.main = $(`<div class='sqlite_table' style='width:${this.width}px; height:${this.height}px; position:absolute; top:${this.top}; left:${this.left};background-color:rgba(8,10,10,0.5); cursor:grab;'></div>`);
        ...
        this.title = $(`<div></div>`);
        this.title_input = $(`<input type="text"  name="name" value='${this.name}' style='width:100%;color:grey;border:none;background-color:inherit;outline:none;text-align:center;'readonly></input>`);
        this.title.append(this.title_input);
        this.body = $(`<div style='width:100%; height100%; overflow:scroll; margin:0 auto;background-color:inherit; color:grey;padding-left:3px;padding-right:3px;'></div>`);
        this.table = $(`<table style='width:100%;position:relative;background-color:inherit; color:inherit;'><tr style='background-color:black;font-size:0.7em; '> <th style='position:sticky; top:0px; z-index:2;background-color:inherit;font-size:inherit;'>Name</th> <th style='font-size:inherit;background-color:inherit;position:sticky; top:0px;z-index:2;'>Type</th> <th style='font-size:inherit;background-color:inherit;position:sticky; top:0px;z-index:2;'>PK</th> <th style='font-size:inherit;background-color:inherit;position:sticky; top:0px;z-index:2;'>FK</th><th style='font-size:inherit;background-color:inherit;position:sticky; top:0px;z-index:2;'>NotNull</th>  </tr></table>`);
